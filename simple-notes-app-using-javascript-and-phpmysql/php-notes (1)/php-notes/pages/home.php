        ...
        <div class="card rounded-0 mb-3">
            <div class="card-header rounded-0">
                <div class="d-flex w-100 justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-primary rounded-0 btn-sm bg-gradient" id="add_new_note" type="button"><i class="fa fa-plus-square"></i> Add New</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-auto">
                                <a href="javascrip:void(0)" data-id="<?= $note['id'] ?>" data-is-pinned="<?= $note['pinned'] ?>" class="px-2 py-1 pin-note" title="<?= $note['pinned'] == 0? 'Pin to top' : 'Unpin' ?>">
                                    <?php if($note['pinned'] == 0): ?>
                                        <i class="fa-solid fa-map-pin text-secondary opacity-75"></i>
                                    <?php else: ?>
                                        <i class="fa-solid fa-map-pin text-primary opacity-100"></i>
                                    <?php endif; ?>
                                </a>
                            </div>
                            <div class="col-auto">
